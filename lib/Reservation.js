...
class Reservation extends EventEmitter {
    ...
    conference(options = {}) {
        ...
        return this._request.post(requestURL, requestParams, API_V1, this.version).then(() => this);
    }
    ...
    updateParticipant(options) {
        ...
        return this._request.post(requestURL, requestParams, API_V2, this.version).then(() => this);
    }
