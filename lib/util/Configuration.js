...
export default class Configuration {
    constructor(token, options = {}) {
        ...
        this.token = token;
        if (options.region) {
            this.EB_SERVER = 'https://event-bridge.' + options.region + '-ix.us1.twilio.com/v1/wschannels';
            this.WS_SERVER = 'wss://event-bridge.' + options.region + '-ix.us1.twilio.com/v1/wschannels';
        } else {
