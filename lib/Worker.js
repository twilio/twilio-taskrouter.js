...
class Worker extends EventEmitter {
    ...
    constructor(token, options = {}, deps = { Request, EventBridgeSignaling, GraphQLSignaling }) {
        ...
        const types = {
            connectActivitySid: (val) => typeof val === 'undefined' || isString(val),
            closeExistingSessions: (val) => typeof val === 'undefined' || isBoolean(val),
            logLevel: (val) => typeof val === 'undefined' || isString(val),
            ebServer: (val) => typeof val === 'undefined' || isString(val),
            wsServer: (val) => typeof val === 'undefined' || isString(val),
            region: (val) =>  typeof val === 'undefined' || isString(val),
            enableVersionCheck: (val) => typeof val === 'undefined' || isBoolean(val),
            useGraphQL: (val) => typeof val === 'undefined' || isBoolean(val),
        };
