...
class Worker extends EventEmitter {
    ...
    _subscribeToSignalingEvents() {
        ...
        this._signaling.on('tokenExpired', () => {
            this._log.info('Received Event: \'tokenExpired\' for Worker %s. Please update the token. Websocket will not reconnect automatically until token is updated.', this.sid);
