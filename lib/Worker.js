...
class Worker extends EventEmitter {
    constructor(token, options = {}) {
        ...
        this._dataServices = {
            ...
            channelsEntity: new ChannelsEntity(this._config, this, this._request),
            reservationsEntity: new ReservationsEntity(this._config, this, this._request)
        };
    ...
    _subscribeToSignalingEvents() {
        ...
        this._signaling.on('init', evt => {
            this._log.info('Received Event: \'init\' from Signaling layer. Proceeding to initialize Worker %s.', evt.channel_sid);
