...
class Worker extends EventEmitter {
     ...
     * @returns {Promise<this>} - Rejected if unable to create a Task on behalf of the {@link Worker}
     *//**
     * @typedef {Object} Worker.TaskOptions
     * @property {object} [attributes=null] - Additional attribues for the {@link Task}
     * @property {string} [taskChannelUniqueName=''] - The friendly name of the {@link Channel} this {@link Task} belongs to. If not provided, defaults to 'default' channel.
    ...
    createTask(to, from, workflowSid, taskQueueSid, options = {}) {
        ...
        // set attributes specially
        const requiredAttributes = {
            // eslint-disable-next-line camelcase
            outbound_to: to,
            from: from
        };
        const attributes = Object.assign({}, options.attributes, requiredAttributes);
