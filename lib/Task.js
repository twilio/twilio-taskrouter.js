...
import { API_V1, API_V2, TASK_STATUS_COMPLETED, TASK_STATUS_WRAPPING, taskTransferEventTypes } from './util/Constants';
...
class Task extends EventEmitter {
    ...
    _emitEvent(eventType, rawEventData) {
        ...
        // Transfer events only occur for outgoing transfers.
        if (Object.values(taskTransferEventTypes).indexOf(eventType) > -1) {
 ...
 */
 ...
 /**
 * The {@link Task}'s transfer has successfully been cancelled
 * @event Task#transferCanceled
 * @param {Task} task - The {@link Task} whose transfer was canceled
 */

/**
 * The {@link Task} has successfully been transferred to the desired entity
 * @event Task#transferCompleted
 * @param {Task} task - The {@link Task} whose transfer was completed
 */
