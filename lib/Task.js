...
import { CUSTOMER_PARTICIPANT_INSTANCE, TASK_INSTANCE, TASK_TRANSFER } from './util/Routes';
...
class Task extends EventEmitter {
    ...
    /**
     * Hold the customer leg of the Conference referenced by the {@link Task}
     * @deprecated since version 0.2.9, use {@link Task#updateParticipant} instead
     * @returns {Promise<this>} - Rejected if unable to issue the hold
     */
    hold() {
    ...
    /**
     * Unhold the customer leg of the Conference referenced by the {@link Task}
     * @deprecated since version 0.2.9, use {@link Task#updateParticipant} instead
     * @returns {Promise<this>} - Rejected if unable to issue the hold
     */
    unhold() {
     ...
     * @property {boolean} [hold=null] - Whether to hold the customer leg of the Conference refernced by the {@link Task}
     */
