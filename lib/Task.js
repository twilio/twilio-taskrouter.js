...
class Task extends EventEmitter {
     ...
     * @param {String } targetWorkerSid - The target worker participant Sid to be put pn hold for the {@link Task} and specified TargetWorkerSid
     * @param {Boolean} onHold - Whether to hold the worker leg of the Conference referenced by the {@link Task} and specified TargetWorkerSid
