...
import { taskEventTypes, taskTransferEventEmitterMapping, completeReservationEvents } from '../util/Constants';
...
export default class TaskRouterEventHandler {
    ...
    _reservationCleanupEventsHandler(eventData, eventType) {
        const mappedEventType = completeReservationEvents[eventType];
