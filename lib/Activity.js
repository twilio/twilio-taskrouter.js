...
class Activity {
     ...
     * @param {Activity.UpdateOptions} [options] - Represents whether all pending reservations should be rejected with the update to an unavailable {@link Activity}.
     * @returns {Promise<this>} - Rejected if the {@link Worker}'s activity state could not be set
     *//**
     * @typedef {Object} Activity.UpdateOptions
     * @property {boolean} [rejectPendingReservations=false] - 
     */
