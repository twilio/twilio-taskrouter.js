...
describe('Reservation', () => {
    ...
    const pendingReservationDescriptor = new ReservationDescriptor(pendingReservationInstance, config);
    const assignedReservationDescriptor = new ReservationDescriptor(assignedReservationInstance, config);
    ...
    describe('#accept', () => {
        ...
        it('should accept the reservation', () => {
            ...
            const pendingReservation = new Reservation(config, new Request(config), pendingReservationDescriptor);
    ...
    describe('#_emitEvent(eventType, rawEventData)', () => {
        ...
        it('should emit Event:on(completed) and update the Reservation and Task', () => {
            ...
            const assignedReservation = new Reservation(config, new Request(config), assignedReservationDescriptor);
