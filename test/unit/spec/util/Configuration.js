...
describe('Configuration', () => {
  describe('constructor', () => {
    ...
    it('should set environment option if passed in', () => {
      const options = {
        ebServer: 'https://event-bridge.dev-us1.twilio.com/v1/wschannels/{accountSid}/{workerSid}',
        wsServer: 'wss://event-bridge.dev-us1.twilio.com/v1/wschannels/{accountSid}/{workerSid}'
      };
