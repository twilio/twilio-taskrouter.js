...
describe('Configuration', () => {
  describe('constructor', () => {
    ...
    it('region should append to ebServer', () => {
        ...
        assert.equal(config.EB_SERVER, 'https://event-bridge.dev-us1.ie1-ix.us1.twilio.com/v1/wschannels');
        assert.equal(config.WS_SERVER, 'wss://event-bridge.dev-us1.ie1-ix.us1.twilio.com/v1/wschannels');
    });
