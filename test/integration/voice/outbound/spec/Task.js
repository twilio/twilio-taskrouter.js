        ...
        it('should throw a validation error when using an incorrect workflow sid', () => {
            return new Promise(async(resolve, reject) => {
                ...
                try {
                    ...
                    expect(err.toString()).contain('status code 400', 'expecting a bad request');
                    expect(err.toString()).contain(expected, 'Got a different validation failure than expected');
